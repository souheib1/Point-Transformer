...
from components.transition_layers_bis import TransitionDownLayer


class PointTransformerModel(nn.Module):
    def __init__(self, npoints=1024, nblocks=4, k=16, num_class=40, input_dim=6,pooling='max',sampling='density'):
        super().__init__()
